  ...
  function install() {
    ...
    style.textContent = `
      ...
      *,*::before,*::after{box-sizing:border-box}
      ...
      .projects-pane{grid-row:1!important;min-height:0;overflow:hidden}
      .work-pane,.inspector-pane{min-height:0;overflow:hidden}
      ...
      @media (max-width:1500px){
        ...
        .app-shell{grid-template-rows:66px 66px minmax(0,1fr)}
        .pipeline,.pipeline button{min-height:66px}
        ...
        .project-workspace{grid-template-rows:60px 44px minmax(0,1fr) auto}
      }
      ...
      @media (max-width:1180px){
        ...
        .app-header{grid-template-columns:var(--projects) minmax(0,1fr) var(--inspector)}
        .command-suggestions{grid-template-columns:1fr}
