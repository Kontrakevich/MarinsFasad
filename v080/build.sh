...
text = text.replace('/static/styles.css?v=0.6.1', '/static/styles.css?v=v07-exact-080')
text = text.replace('<script src="/static/app.js?v=0.6.1"></script>', '<script src="/static/app-v080.js?v=v07-exact-080"></script>')
...
rm -rf .test-data
echo "Marins Facade v0.8.0 build passed with exact v0.7 interface"
