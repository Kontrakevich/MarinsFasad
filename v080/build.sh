...
grep -q 'layer1-technical-then-layer2-alignment' "$ROOT/app/intelligence/store.py"
...
print("System №1 learning: regression evidence + project preference candidates; no automatic permanent promotion")
...
echo "Marins Facade v0.8.1 quality-outpaint + System1 Intelligence build passed"
